...
- MAE: \$34.41 per MWh (19% error)
- R²: 85.3% (explains most price variation)
- Bias: \$-9.77 per MWh (nearly unbiased)
- Volatility capture: 92% of actual market swings

**Works well on:**
- Typical prices (\$150-\$300, 87% of data): MAE \$34.41
- Mid-day hours: stable, predictable
- Locations near generation hubs

**Struggles with:**
- Extreme prices (>\$362.16): MAE jumps to \$82.39
- Morning/evening peaks: highest volatility
- Grid edge locations: MTO0331, WKO0331, DOB0661, ASY0111, STK2201
...
Accuracy: 48-hour horizon achieves MAE \$34.41 per MWh on holdout data. Extending to 7-14 days would degrade accuracy as weather and market conditions become unpredictable.
...
| **Total** | **15** | **13 known covariates + 2 static features** | |
...
Achieves MAE $34.41 per MWh on holdout data—significantly better than gradient boosting and more robust than simpler deep learning models like DeepAR.
...
|--------|-------|-----------------|
| **MAE** | \$34.41 per MWh | On average, predictions are off by \$34.41. With mean price \$181.17, that's 19% error. |
| **RMSE** | \$51.42 per MWh | Larger errors are penalized more. This being higher than MAE means some predictions are way off. |
| **R²** | 0.8534 | The model explains 85.3% of price variation. Remaining 14.7% is unpredictable noise. |
| **Bias** | \$-9.77 per MWh | Predictions are \$-9.77 too low on average. That's only -5.4% of mean price—nearly unbiased. |
| **Mean Actual** | \$181.17 per MWh | Average price during test period. |
| **Mean Predicted** | \$171.40 per MWh | Average model prediction. Close to actual mean = good calibration. |
...
**Prediction distribution:** 43.1% overpredictions, 56.9% underpredictions. Slight tendency to underestimate.
...
|-----------|--------|------------|
| **Overall accuracy** | MAE \$34.41 (19% of mean) | Solid baseline—use with confidence for typical prices |
| **Bias** | Nearly unbiased (\$-9.77, -5.4%) | No systematic correction needed |
| **Extreme prices** | High prices (≥\$362.16): MAE \$82.39 | Add 20-30% safety margin for tail risk |
| **Volatility capture** | 92% of actual volatility | Good—model understands market dynamics |
| **Time of day** | Best: 14:00 (MAE \$26.49), Worst: 6:00 (MAE \$52.13) | Increase margins during peak hours |
| **Location variation** | MAE range: \$28.67 to \$39.67 | Monitor high-volatility locations |
...
| price_bin   |      MAE |   Mean_Actual |   Count |   Mean_Predicted |       Bias |       Pct |
|:------------|---------:|--------------:|--------:|-----------------:|-----------:|----------:|
| $0-50       |  11.9204 |       10.9843 |  139013 |          14.0845 |    3.10021 | 33.3806   |
| $50-100     |  95.3081 |       77.7937 |    2285 |         138.339  |   60.5453  |  0.548688 |
| $100-150    |  91.4498 |      130.369  |    7963 |         220.992  |   90.6224  |  1.91212  |
| $150-200    |  25.4507 |      181.289  |   47188 |         196.49   |   15.2004  | 11.3311   |
| $200-300    |  45.9538 |      248.021  |  118625 |         231.017  |  -17.0038  | 28.4849   |
| $300-500    |  49.0287 |      342.36   |  100774 |         303.409  |  -38.9516  | 24.1985   |
| $500+       | 319.559  |      538.555  |     424 |         218.996  | -319.559   |  0.101813 |

Asymmetric bias pattern: Overestimates low prices ($0-$150), underestimates high prices ($200+). Massive underestimation for $500+ prices (bias -\$320). Good performance for $150-$300 (87% of data).
...
Distribution: Mean MAE \$34.41 across 244 locations (std: \$2.04). Range: \$28.67 to \$39.67.

Best performing locations:

| item_id   |     MAE |   Mean_Actual |        Bias |
|:----------|--------:|--------------:|------------:|
| KAW0112   | 28.6685 |       166.24  |  -1.52265   |
| WRK0331   | 29.8151 |       167.98  |  -5.55927   |
| WTU0331   | 29.9541 |       169.71  |  -9.32108   |
| NAP2202   | 30.0701 |       167.622 |  -1.17754   |
| BEN2201   | 30.2217 |       180.297 |  -7.68408   |
| CYD0331   | 30.8315 |       182.52  |  -6.96172   |
| HWA1102   | 30.8364 |       172.869 |   0.0571349 |
| KAW0111   | 31.0144 |       165.847 |  -8.55648   |
| WTK2201   | 31.2179 |       180.968 | -10.0215    |
| ROT1101   | 31.3214 |       171.911 |  -7.6986    |

Worst performing locations:

| item_id   |     MAE |   Mean_Actual |      Bias |   Actual_Volatility |
|:----------|--------:|--------------:|----------:|--------------------:|
| MTO0331   | 39.6728 |       188.104 | -12.2257  |             138.101 |
| WKO0331   | 38.8566 |       184.394 |  -1.66848 |             135.796 |
| DOB0661   | 38.8123 |       203.014 | -17.663   |             148.467 |
| ASY0111   | 38.7339 |       201.313 | -18.6406  |             148.706 |
| STK2201   | 38.724  |       201.391 | -20.1705  |             148.148 |
| ARG1101   | 38.5709 |       200.819 | -18.7796  |             147.702 |
| SVL0331   | 38.4556 |       182.392 | -16.4949  |             133.818 |
| HEP0331   | 38.4018 |       182.599 | -16.1971  |             134.069 |
| CPK0111   | 38.3815 |       181.258 | -15.5745  |             134.531 |
| DOB0331   | 38.327  |       203.179 | -19.0707  |             148.584 |
...
Weakness: When prices spike above \$362.16 (20,833 instances, 5.0% of data), MAE jumps to \$82.39 (23% error vs 19% overall). Predictions compress toward $150-200 regardless of actual price.

When prices drop below \$0.03, MAE is \$7.62. Predictions rarely fall below $80.
...
Strengths:
- Nearly unbiased predictions (only \$-9.77 systematic error)
...
- Location-specific performance varies (MAE \$28.67 to \$39.67)
...
- Locations with MAE >\$39.67: MTO0331, WKO0331, DOB0661, ASY0111, STK2201
...
- Train separate extreme value model for prices >\$362.16
